...
Using the FUSE filesystem worked on previously, implemented a Fault Tolerance concepts. A highly scaleable client-server model is designed and implemented that supports advanced features such as server replication for performance and fault tolerance. 
